...
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>{{ config('app.name') }} – Fingerprint Time &amp; Attendance</title>
    ...
    <div class="page page-center">
        <div class="container container-tight py-4">
            <div class="text-center">
                <img src="{{ asset('images/logo.png') }}{{ $av }}" alt="BioAttent" class="mb-4" height="56">
                <h1 class="display-5 fw-bold">Fingerprint Time &amp; Attendance</h1>
                <p class="text-secondary fs-4 mb-5">Manage attendance, payroll and reports across locations.</p>
                @if(Route::has('login'))
                    @auth
